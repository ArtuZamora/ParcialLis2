                ...
                <div class="col-12 px-5">
                    <div class="card mb-4">
                        ...
                        <div class="card-body p-5">
                            <form role="form" action="<?= PATH ?>/Usuario/Add" enctype="multipart/form-data" method="POST">
                                <div class="row d-flex justify-content-center">
                                    <div class="col-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="password" class="form-control" name="password" value="<?= isset($user) ? $user['Password'] : '' ?>" placeholder="Ingresa la contraseña">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="password" class="form-control" name="passwordRepeat" value="<?= isset($user) ? $user['PasswordRepeat'] : '' ?>" placeholder="Repita la contraseña">
                                            </div>
